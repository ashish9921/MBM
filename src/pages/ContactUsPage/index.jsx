...
import { faAlignCenter, faBars, faHome, faPager, faUserTie, faX } from "@fortawesome/free-solid-svg-icons";
    ...
    <>
      ...
      {sidebar ?
        <div className=" relative w-screen min-h-screen ">
          <FontAwesomeIcon className="left-8 absolute top-10" onClick={() => { setSidebar(false) }} icon={faX} />
          {/* <button >close</button> */}
          <div className="absolute left-[40%] top-36 gap-9 flex flex-col text-start  bg-white-A700 ">
            <div >
              <FontAwesomeIcon icon={faHome} />  Home</div>
            <div  ><FontAwesomeIcon icon={faPager} />  About Us</div>
            <div><FontAwesomeIcon icon={faAlignCenter} /> Courses</div>
            <div><FontAwesomeIcon icon={faUserTie} /> Community</div>
      ...
      <div className="w-full   bg-gray-100_01">
        ...
        <header className="p-[11px] bg-gray-100_b2">
          <div className="flex md:flex-col justify-between items-center w-full gap-5 mx-auto max-w-[1288px]">
            <div className="flex md:flex-row justify-between items-center  w-[76%] md:w-full gap-5 md:p-0">
              <Img
                src="images/img_screen_shot_04_26_23.png"
                alt="screenshotfour"
                className="w-[12%] md:w-[18%]  object-cover"
              />
              <FontAwesomeIcon className="invisible md:visible text-orange-600 " onClick={() => { setSidebar(true) }} icon={faBars} />
              {/* <button className="invisible md:visible " onClick={() => { setSidebar(true) }}>dropdown</button> */}
              <ul className="flex md:hidden justify-center gap-[45px] sm:flex-wrap">
                <li>
              ...
              <div className="flex md:hidden justify-center w-[15%] md:w-full">
            ...
            <Button size="md" shape="round" className="sm:px-5 md:hidden uppercase font-bold min-w-[129px]">
              register
            </Button>
          </div>
        </header>
            ...
            <div className="self-stretch">
              <div>
                <div className="flex md:flex-col justify-center items-center gap-5 py-14  md:p-5 bg-deep_orange-A200_e5">
                  <div className="max-w-[1045px] flex flex-row gap-16 sm:gap-3 mb-16  justify-between ">
                    <div className="flex flex-col items-start mt-0.5   md:ml-0">
                      ...
                      <Heading size="md" as="h2" className="sm:text-sm mt-[60px] sm:mt-[20px] !text-white-A700 tracking-[0.20px]">
                        Do you have any concerns or questions you would like to address?
                      </Heading>
                      <Heading size="md" as="h3" className="sm:text-sm mt-[26px] sm:mt-[10px] !text-white-A700 tracking-[0.20px]">
                    ...
                    <Img
                      ...
                      alt="circleimage"
                      className="h-[208px] w-[208px] sm:h-[100px] sm:mt-5 sm:w-[100px] md:mr-0 rounded-[50%]"
                    />

                  </div>

                </div>
                <div className="flex flex-col items-center w-full mt-[-102px] sm:mt-[-70px]  p-[38px] mx-auto md:p-5 bg-gray-100_01 shadow-xs max-w-[1045px] rounded-[20px]">
        ...
        <footer className="mt-[140px] p-[21px] sm:p-1 bg-gray-300">
          <div className="flex flex-col items-center justify-center w-full gap-[50px] mx-auto my-2 max-w-[1322px]">
            <div className="flex md:flex-col self-stretch justify-center items-start gap-8">
              <div className="md:hidden flex flex-col w-full gap-[18px] md:p-5">
                <Img
              ...
              <div className=" gap-5 invisible md:visible hidden flex-col w-full  md:p-5 "  >
                ...
                <div className="flex justify-between md:justify-start w-[36%] md:w-full gap-5">
              ...
              <div className="flex  justify-between items-start w-full gap-5 md:p-2">
              ...
              <div className=" md:hidden flex flex-col w-full gap-4 md:p-5">
                <Heading as="h6">Need help?</Heading>
                <div className="h-[46px] bg-gray-50 shadow-sm relative rounded-lg">
                  <div className="flex justify-between items-center h-[46px]  absolute -bottom-0.5 w-full">
                    <Text size="s" as="p" className=" ml-3.5 w-full">
            ...
            <div className="flex md:hidden sm:flex-col justify-center items-start w-[31%] md:w-full pt-px pr-px gap-2">
